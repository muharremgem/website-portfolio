...
function Skills({ skills }: Props) {
  return (
    ...
    >
      <h3 className="absolute mm:hidden md:block top-24 uppercase tracking-[20px] text-gray-500 text-2xl">
        Skills
      </h3>

      <h3 className="absolute md:top-36 mm:top-[5rem] uppercase tracking-[3px] text-gray-500 text-sm">
